        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center py-6">
            <div className="flex justify-start">
              <span className="text-2xl font-bold text-primary-600">CRM System</span>
            </div>
              ...
              <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                  <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
                    ...
                    <span className="block text-primary-600">business relationships</span>
                  </h1>
                ...
                <div className="pt-6">
                  <div className="flow-root bg-white rounded-lg px-6 pb-8">
                    <div className="-mt-6">
                      ...
                      <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Deal Tracking</h3>
                      <p className="mt-5 text-base text-gray-500">
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
          ...
          <div className="mt-8 md:mt-0 md:order-1">
            <p className="text-center text-base text-gray-400">
              &copy; 2023 CRM System. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
